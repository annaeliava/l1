...
if(confirm('Нажав ok, все данные в localStorage будут удалены. Чтобы предотвратить данное действие, нажмите на "Отмена"')) {
    ...
    // считаем, насколько заполнена 
    const getMaxSpaceLocalStorage = () => {
        let total = 0;
        ...
        return "Максимальный объем данных: " + total.toFixed(2) + " Кб";
    };

    console.log(getMaxSpaceLocalStorage()); // Максимальный объем данных: 9911.84 Кб
